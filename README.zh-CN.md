...
本仓库 `main` 发布的是 APG `0.4.0-dev.20260813` 开发快照。核心包包含已经完成并通过仓库验证的 P3-A 至 P3-J 能力以及对齐后的 `RPD.md`，`MANIFEST.json` 提供确定的核心文件集合和哈希。这个事实不自动证明：
...
- 版本：`0.4.0-dev.20260813`
- 核心包文件数：90（另含 `MANIFEST.json`）
- `MANIFEST.json` SHA-256：`6fedb7075fec853a2b7912ca7b840bd21a2c63d6b9cb1ebb567561eb72556bcf`
- 离线 guided-intake 示例：6 个
- 运行方式：开发快照、本地、离线、证据优先

不可变的 `v0.3.0` tag 保持不变；P4 尚未开始。
